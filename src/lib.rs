// src/lib.rs
/*
 * Core library for DecentralGems
 */
...
#[derive(Debug)]
pub struct DecentralGemsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DecentralGemsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DecentralGems processing");
    
    let mut processor = DecentralGemsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DecentralGemsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DecentralGemsProcessor::new(false);
